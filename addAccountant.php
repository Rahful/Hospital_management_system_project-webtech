<?php include 'controllers/addaccountantcontroller.php';?>
<html>
<head>
</head>
<body>
        ...
        <fieldset>
        <legend><h1>Add Accountant</h1></legend>
		<div id="add-Btn" >
        <form action="" onsubmit="return validate()" method="post">
            <table>
				...
				<tr>
				<td><td><input type="submit" id="add-Btn" name="Add_accountant" value="Add Accountant"></td></td>
			</tr>
            </table>
        </form>
		</fieldset> 
...
<script src="JS/jsvalidationaccountant.js"></script>
</html>